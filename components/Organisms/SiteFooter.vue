<template>
    <div class="flex p-8 duration-1000 hover:opacity-100">
        <footer
            role="contentinfo"
        ...
        >
            ...
            >
                <div
                    class="to-blaze-orange-500 via-pizazz-500 @container flex w-full flex-col gap-8 bg-gradient-to-b from-orange-500 p-6 text-white lg:w-1/2"
                >
